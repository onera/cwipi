module table_tet_mesh
  ...
  public :: driverTetMesh
  
  interface saveTetMesh ; module procedure saveTetMesh ; end interface
  public :: saveTetMesh
...
subroutine saveTetMesh(ord,node_xyz,tetra_node)
  ...
  do i=1,size(tetra_node,2)
    ...
    vec14(1:3)=node_xyz(1:3,tetra_node(4,i))-node_xyz(1:3,tetra_node(1,i))
  
    det= vec12(1)*(vec13(2)*vec14(3)-vec14(2)*vec13(3)) &
    &   -vec12(2)*(vec13(1)*vec14(3)-vec14(1)*vec13(3)) &
    &   +vec12(3)*(vec13(1)*vec14(2)-vec14(1)*vec13(2))
    
    if( det>0d0 )then    
      write(10,'(4(i6,1x),1x,i1)')tetra_node(1:4,i),0
    elseif( det<0d0 )then
      write(10,'(4(i6,1x),1x,i1)')tetra_node(1,i),tetra_node(3,i),tetra_node(2,i),tetra_node(4,i),0
    elseif( det==0d0 )then
      stop "tetra with jacobian=0"
    endif
  enddo
  write(10,'(/"End")')
  close(10)
...
#define driverTetMesh 0
  ...
  integer ( kind = 4 ), pointer, dimension ( : ) :: ht=>null()
