 ...
 )
{
  ...
  sprintf(fileName,"listing_code_C2_%4.4d",rank); 
  ...
  couplings_add_local_double_control_parameter("physicalTimeC", 0.2);
  ...
  couplings_set_local_double_control_parameter("physicalTimeC", 0.3);
  couplings_set_local_int_control_parameter("niterC", 4);
  ...
  couplings_synchronise_control_parameter("CodeC2"); 
