...
)
{
  ...
  if (rank == 0) {
    ...
    system("mpirun -n 1 cwp_server -cn code1 -p 49100 49100 -c \"client_new_api_c_poly_block_o/code1/cwp_config_srv.txt\" : -n 1 cwp_server -cn code2 -p 49101 49101 -c \"client_new_api_c_poly_block_o/code2/cwp_config_srv.txt\" &");
  }
