...
//   }
  ...
  sprintf(fileName,"c_conservative_mesh_simple_intersection%4.4d.txt",rank);
  ...
  /***************** Maillages intersection simple arete/arete *****************/
...
fvm::fvm_writer_t *fvmWriterIM = fvm::fvm_writer_init("MeshSMSimpleMesh",
  ...
  fvmWriterIM = fvm::fvm_writer_init("MeshTMSimpleMesh",
                                                        "/home/bfrisull/workspace/cwipi/src/compil/meshes",
                                                        "Ensight Gold",
                                                        "text",
                                                        fvm::FVM_WRITER_FIXED_MESH);
  ...
  fvmWriterIM = fvm::fvm_writer_init("MeshIMSimpleInters",
                                                        "/home/bfrisull/workspace/cwipi/src/compil/meshes",
                                                        "Ensight Gold",
                                                        "text",
                                                        fvm::FVM_WRITER_FIXED_MESH);
  ...
  /*fvmWriterIM = fvm::fvm_writer_init("MeshIMSimpleInters2",
                                     "/home/bfrisull/workspace/cwipi/src/compil/meshes",
                                     "Ensight Gold",
                                     "text",
                                     fvm::FVM_WRITER_FIXED_MESH);
