...
//   }
  ...
  sprintf(fileName,"c_conservative_vertex_vertex_intersection%4.4d.txt",rank);
  ...
  /**************** Maillages intersection sommet/sommet *******************/
...
fvm::fvm_writer_t *fvmWriterIM = fvm::fvm_writer_init("MeshIMVertVertInters",
  ...
  fvmWriterIM = fvm::fvm_writer_init("MeshIMVertVertInters2",
                                     "/home/bfrisull/workspace/cwipi/src/compil/meshes",
                                     "Ensight Gold",
                                     "text",
                                     fvm::FVM_WRITER_FIXED_MESH);
