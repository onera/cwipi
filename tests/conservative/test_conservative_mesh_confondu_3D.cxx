...
//   }
  ...
  sprintf(fileName,"c_conservative_mesh_confondu3D%4.4d.txt",rank);
  ...
  fvm::fvm_writer_t *fvmWriterSM = fvm::fvm_writer_init("MeshSMConfondu3D",
  ...
  fvm::fvm_writer_t *fvmWriterTM = fvm::fvm_writer_init("MeshTMConfondu3D",
                                                        "/home/bfrisull/workspace/cwipi/src/compil/meshes",
                                                        "Ensight Gold",
                                                        "text",
                                                        fvm::FVM_WRITER_FIXED_MESH);
  ...
  sourceMesh = new cwipi::oldMesh(MPI_COMM_WORLD,
                               2 ,
                               nVertexSM,
                               nEltsSM,
                               coordsSM,
...
fvm::fvm_writer_t *fvmWriterIM = fvm::fvm_writer_init("MeshIMConfondu3D",
                                                        "/home/bfrisull/workspace/cwipi/src/compil/meshes",
                                                        "Ensight Gold",
                                                        "text",
                                                        fvm::FVM_WRITER_FIXED_MESH);
  ...
  fvmWriterIM = fvm::fvm_writer_init("MeshIMConfondu3D2",
                                     "/home/bfrisull/workspace/cwipi/src/compil/meshes",
                                     "Ensight Gold",
                                     "text",
                                     fvm::FVM_WRITER_FIXED_MESH);
  ...
  fvmWriterIM = fvm::fvm_writer_init("MeshIMConfondu3D3",
                                     "/home/bfrisull/workspace/cwipi/src/compil/meshes",
                                     "Ensight Gold",
                                     "text",
                                     fvm::FVM_WRITER_FIXED_MESH);
