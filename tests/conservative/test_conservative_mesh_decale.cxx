...
//   }
  ...
  sprintf(fileName,"c_conservative_mesh_decale%4.4d.txt",rank);
  ...
  fvm::fvm_writer_t *fvmWriterIM = fvm::fvm_writer_init("MeshSMDecale",
...
fvmWriterIM = fvm::fvm_writer_init("MeshTMDecale",
                                   "/home/bfrisull/workspace/cwipi/src/compil/meshes",
                                   "Ensight Gold",
                                   "text",
                                                        fvm::FVM_WRITER_FIXED_MESH);
 ...
 fvm::fvm_writer_finalize(fvmWriterIM);
  ...
  fvmWriterIM = fvm::fvm_writer_init("MeshIMDecale",
                                                        "/home/bfrisull/workspace/cwipi/src/compil/meshes",
                                                        "Ensight Gold",
                                                        "text",
                                                        fvm::FVM_WRITER_FIXED_MESH);
  ...
  fvmWriterIM = fvm::fvm_writer_init("MeshIMDecale2",
                                                        "/home/bfrisull/workspace/cwipi/src/compil/meshes",
                                                        "Ensight Gold",
                                                        "text",
                                                        fvm::FVM_WRITER_FIXED_MESH);
  ...
  fvmWriterIM = fvm::fvm_writer_init("MeshIMDecale3",
                                                        "/home/bfrisull/workspace/cwipi/src/compil/meshes",
                                                        "Ensight Gold",
                                                        "text",
                                                        fvm::FVM_WRITER_FIXED_MESH);
  ...
  fvmWriterIM = fvm::fvm_writer_init("MeshIMDecale4",
                                     "/home/bfrisull/workspace/cwipi/src/compil/meshes",
                                     "Ensight Gold",
                                     "text",
                                     fvm::FVM_WRITER_FIXED_MESH);
