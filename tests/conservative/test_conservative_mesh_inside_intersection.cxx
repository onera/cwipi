...
//   }
  ...
  sprintf(fileName,"c_conservative_mesh_inside_intersection%4.4d.txt",rank);
...
fvm::fvm_writer_t *fvmWriterIM = fvm::fvm_writer_init("MeshIMInsideInters",
  ...
  fvmWriterIM = fvm::fvm_writer_init("MeshIMInsideInters2",
                                     "/home/bfrisull/workspace/cwipi/src/compil/meshes",
                                     "Ensight Gold",
                                     "text",
                                     fvm::FVM_WRITER_FIXED_MESH);
