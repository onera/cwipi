...
)
{
  ...
  if (i_rank == 0) {
    ...
    sprintf(cmd, "mpirun -n %d ../bin/cwp_server -cn code1 -p %d %d -c \"client_new_api_multiple_o/code1/cwp_config_srv.txt\" \
                  : -n %d  ../bin/cwp_server -cn code2 -p %d %d -c \"client_new_api_multiple_o/code2/cwp_config_srv.txt\" &",
