...
)
{
  ...
  sprintf(fileName,"c_surf_location_curvetriaP2_%4.4d.txt",rank);
  ...
  pts_to_locate[21] = 0.;
  pts_to_locate[22] = _f(0., 0, 0) + 0.005;
  pts_to_locate[23] = 0.;

  pts_to_locate[24] = xmin - 0.005;
  pts_to_locate[25] = _f(xmin - 0.005, 0., zmin - 0.005);
  pts_to_locate[26] = zmin - 0.005;

  pts_to_locate[27] = (xmax + xmax/2.) / 2 + 0.005;
  pts_to_locate[28] = _f((xmax + xmax/2.) / 2 + 0.005, 0, zmax/4. + 0.005);
  ...
  cwipi_locate("c_surf_cpl_location_curvetriaP2");

  nNotLocatedPoints = cwipi_get_n_not_located_points("c_surf_cpl_location_curvetriaP2");
  ...
  cwipi_delete_coupling("c_surf_cpl_location_curvetriaP2");
