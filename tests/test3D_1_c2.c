...
int main( int argc, char* argv[] ) {
  ...
  if (nb_procs > 1)
    bft_error(__FILE__, __LINE__, 0,"Test3D_1_c2 is not a parallel application\n");


  BFT_MALLOC(fileOutput, strlen("listing_test3D_1_c2_")+ 4 + 1, char );
  sprintf( fileOutput, "listing_test3D_1_c2_%4.4d", localRank );
