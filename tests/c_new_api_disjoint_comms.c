...
) 
{
  ...
  PDM_dcube_t *dcube = PDM_dcube_gen_init(pdm_comm,
                                          n_vtx_seg,
                                          length,
                                          xmin,
                                          ymin,
  ...
  int          s_face_group;
  int          n_face_group;
  int         *d_face_vertex_idx = NULL;
  int         *d_face_group_idx  = NULL;
  PDM_g_num_t *d_face_cell       = NULL;
  PDM_g_num_t *d_face_vertex     = NULL;
  PDM_g_num_t *d_face_group      = NULL;
