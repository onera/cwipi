...
//   }
  ...
  sprintf(fileName,"c_conservative_vertex_confondu%4.4d.txt",rank);
  ...
  /*for(int i = 0; i < n; i++){
    for(int j = 0; j < m ; j++){
      coordsTM[3*(m*i+j)] = 1.*j/2 ;
      coordsTM[3*(m*i+j) + 1] = 1.*i/2;
  ...
  */
  ...
  for(int i = 0; i < 3; i++){
    for(int j = 0; j < 3 ; j++){
      coordsSM[3*(3*i+j)] = 1 - j;
      coordsSM[3*(3*i+j) + 1] = - i;
      coordsSM[3*(3*i+j) + 2] = 0;
     }
  }
  ...
  cwipi::ConservativeMesh* intersMesh5 = new cwipi::ConservativeMesh(fvmComm,
                                                                    *sourceMesh,
                                                                    *targetMesh,
                                                                    0.01);


  cwipi::ConservativeMesh* intersMesh6 = new cwipi::ConservativeMesh(fvmComm,
                                                                    *targetMesh,
                                                                    *sourceMesh,
                                                                    0.01);*/
  ...
  /*cwipi::ConservativeMesh* intersMesh7 = new cwipi::ConservativeMesh(fvmComm,
                                                                    *sourceMesh,
                                                                    *targetMesh,
                                                                    0.01);*/


  cwipi::ConservativeMesh* intersMesh8 = new cwipi::ConservativeMesh(fvmComm,
                                                                    *targetMesh,
                                                                    *sourceMesh,
                                                                    0.01);

fvm::fvm_writer_t */*fvmWriterIM = fvm::fvm_writer_init("MeshIMVertexConfondu",
  ...
  fvmWriterIM = fvm::fvm_writer_init("MeshIMVertexConfondu2",
                                                        "/home/bfrisull/workspace/cwipi/src/compil/meshes",
                                                        "Ensight Gold",
                                                        "text",
                                                        fvm::FVM_WRITER_FIXED_MESH);
  ...
  fvmWriterIM = fvm::fvm_writer_init("MeshIMVertexConfondu3",
                                                        "/home/bfrisull/workspace/cwipi/src/compil/meshes",
                                                        "Ensight Gold",
                                                        "text",
                                                        fvm::FVM_WRITER_FIXED_MESH);
  ...
  fvmWriterIM = fvm::fvm_writer_init("MeshIMVertexConfondu4",
                                     "/home/bfrisull/workspace/cwipi/src/compil/meshes",
                                     "Ensight Gold",
                                     "text",
                                     fvm::FVM_WRITER_FIXED_MESH);
  ...
  fvmWriterIM = fvm::fvm_writer_init("MeshIMVertexConfondu5",
                                     "/home/bfrisull/workspace/cwipi/src/compil/meshes",
                                     "Ensight Gold",
                                     "text",
                                     fvm::FVM_WRITER_FIXED_MESH);
  ...
  fvm::fvm_writer_export_nodal(fvmWriterIM, 
                               &(intersMesh5->getIntersectionMesh()->getFvmNodal()));

  fvm::fvm_writer_finalize(fvmWriterIM);


  fvmWriterIM = fvm::fvm_writer_init("MeshIMVertexConfondu6",
                                                        "/home/bfrisull/workspace/cwipi/src/compil/meshes",
                                                        "Ensight Gold",
                                                        "text",
                                                        fvm::FVM_WRITER_FIXED_MESH);
  ...
  fvm::fvm_writer_export_nodal(fvmWriterIM, 
                               &(intersMesh6->getIntersectionMesh()->getFvmNodal()));

  fvm::fvm_writer_finalize(fvmWriterIM);


  fvmWriterIM = fvm::fvm_writer_init("MeshIMVertexConfondu7",
                                                        "/home/bfrisull/workspace/cwipi/src/compil/meshes",
                                                        "Ensight Gold",
                                                        "text",
                                                        fvm::FVM_WRITER_FIXED_MESH);
  ...
  fvm::fvm_writer_export_nodal(fvmWriterIM, 
                               &(intersMesh7->getIntersectionMesh()->getFvmNodal()));

  fvm::fvm_writer_finalize(fvmWriterIM);



                   */ fvmWriterIM = fvm::fvm_writer_init("MeshIMVertexConfondu8",
                                     "/home/bfrisull/workspace/cwipi/src/compil/meshes",
                                     "Ensight Gold",
                                     "text",
                                     fvm::FVM_WRITER_FIXED_MESH);
  ...
  fvm::fvm_writer_export_nodal(fvmWriterIM, 
                               &(intersMesh8->getIntersectionMesh()->getFvmNodal()));
