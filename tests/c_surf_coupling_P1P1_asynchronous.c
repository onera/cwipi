...
)
{
  ...
  *srcBaseName = '\0';
  ...
  cwipi_create_coupling("c_surf_cpl_P1P1_async",                                // Coupling id
  ...
  /*  cwipi_exchange_status_t status = cwipi_exchange("c_surf_cpl_P1P1_async",
                                                  "ech",
                                                  1,
                                                  1,     // n_step
                                                  0.1,   // physical_time
  ...
  cwipi_issend("c_surf_cpl_P1P1_async",
               "ech",
               tag,
               1,
               1,
  ...
  cwipi_delete_coupling("c_surf_cpl_P1P1_async");
