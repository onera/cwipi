...
//  int init_random = (int) time(NULL);
  ...
  if (version == CWP_VERSION_OLD) {
    ...
    CWP_Spatial_interp_property_add(code_name[0], coupling_name, "tolerance", "double", "1e-2");

    CWP_Spatial_interp_property_add(code_name[0], coupling_name, "tolerance", "double", "2e-2");
