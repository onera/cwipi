...
namespace cwipi {
  ...
  public:
   ...
   /**
    * \brief Create the visu geometry
    *
    ...
    */
    ...
    void GeomCreate(int n_part);
     ...
     /**
     * \brief Set the Visu geometry coordinates
     *
    ...
    void GeomCoordSet(int id_part,
     ...
     /**
     * \brief Addition of a block (set of cells) to a Visu geometry partition
     *
     * This function add a block to a Visu geometry partition
     *
   ...
   /**
    * \brief Set a standard block to a Visu geometry partition
    *
    ...
    */
    ...
    void GeomBlockGNumMeshSet (int id_block,
     ...
     /**
     * \brief Set a face polygon block to a Visu geometry partition
     *
     * \param [in] id_part     Partition identifier
     * \param [in] id_block    Block identifier
     * \param [in] n_elt       Number of block elements
     ...
     */
     ...
     /**
     * \brief Set a face polhedron block to a Visu geometry partition
     *
     * \param [in] id_part           Partition identifier
     * \param [in] id_block          Block identifier
