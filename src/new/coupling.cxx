...
//      abort();
      ...
      printf("Coupling::spatialInterpWeightsCompute - field name : <%s> <%s>\n",
             localFieldsName.c_str(), cplFieldName.c_str());
      fflush(stdout);
...
//TODO: Pourquoi le if commente              std::map <std::string, cwipi::Field *>::iterator it2 = cpl_cpl._fields.begin();
