...
namespace cwipi {
  ...
  class MappingLocation: public Mapping 
    ...
    private:     
        ...
        void init(Coupling *coupling, CWP_Field_value_t mappingLocation,int slave) ;     
       ...
       CWP_Field_value_t    _mappingLocation  ;  /*!< Points cloud treated by this mapping instance (cell centers, vertices or user defined) */
