...
)
{
  ...
  PDM_generate_mesh_sphere_simplified(_comm,
                                       n_vtx,
                                       n_elt,
                                       coords,
                                       elt_vtx_idx,
...
)
{
  ...
  PDM_generate_mesh_rectangle_simplified (              _comm,
...
)
{
  ...
  PDM_generate_mesh_ball_simplified (_comm,
                                      n_vtx,
                                      n_elt,
                                      coords,
                                      elt_vtx_idx,
...
)
{
  ...
  PDM_generate_mesh_parallelepiped_simplified (              _comm,
                                                (PDM_g_num_t) n_vtx_seg,
                                                              n_vtx,
                                                              n_elt,
                                                              coords,
...
)
{
  ...
  PDM_generate_mesh_rectangle_ngon (                       _comm,
...
)
{
  ...
  PDM_generate_mesh_sphere_ngon (                       _comm,
                                  (PDM_Mesh_nodal_elt_t) elt_type,
                                                         order,
                                                         ho_ordering,
                                                         radius,
...
)
{
  ...
  PDM_generate_mesh_ball_ngon (                       _comm,
                               (PDM_Mesh_nodal_elt_t) elt_type,
                                                      order,
                                                      ho_ordering,
                                                      radius,
...
)
{
  ...
  PDM_generate_mesh_parallelepiped_ngon (                        _comm,
                                         (PDM_Mesh_nodal_elt_t) elt_type,
                                                                order,
                                                                ho_ordering,
                                                                xmin,
