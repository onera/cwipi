...
void GeomLocation::issend(Field* referenceField) {
      ...
      for (int i_proc = 0; i_proc < _n_ranks_cpl; i_proc++) {    
        ...
        int longueur = dataTypeSize * nComponent * (_targets_localization_idx_cpl[distant_rank][_nb_part]-_targets_localization_idx_cpl[distant_rank][0]);
...
void GeomLocation::issend2(Field* referenceField) {
