  ...
  case FVMC_FACE_TRIA: {
    ...
    for (int j = 0; j < _order; j++) {
      ...
      for (int i = ibeg; i < iend - 1; i++) {
        ...
        fvmc_triangle_evaluate_Position (point_coords,
                                         _vertex_coords,
                                         _closest_pointP1,
                                         _uvP1,
                                         &_dist2,
        ...
        /* printf ("triaa %d : %d %d %d\n", tria++, i+1, iend + 2 + k1, iend + 1 + k1); */
      ...
      /* printf ("triaad %d : %d %d %d\n", tria++, iend - 1, iend - 1 + 1, iend + 1 + k1); */
