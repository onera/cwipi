                     ...
                     fvm_lnum_t **vertices)
{
  ...
  *n_elts = 0;
  ...
  BFT_MALLOC(*vertices_index, *n_elts+1, fvm_lnum_t);
  BFT_MALLOC(*vertices, s_vertices, fvm_lnum_t);
                     ...
                     double **coords)
{
  *n_vertex = this_nodal->n_vertices;
  ...
  BFT_MALLOC(*coords,this_nodal->n_vertices * this_nodal->dim , double);
...
{
  bft_error(__FILE__, __LINE__, 0,
            _("fvm_nodal_get_poly_verte : This function is not implemented yet"));
/*   int s_faces = 0; */
/*   int s_vertices = 0; */
...
/*   BFT_MALLOC(*faces_index, *n_elts, fvm_lnum_t); */
/*   BFT_MALLOC(*faces, s_faces, fvm_lnum_t); */
